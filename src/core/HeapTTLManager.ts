...
export class HeapTTLManager {
   ...
   * @param sweepIntervalMs Interval between sweep cycles in milliseconds (default: 100).
   */
  constructor(onExpire: (key: string) => void, sweepIntervalMs: number = 100) {
   ...
   * @returns true if the key had a TTL that was removed, false otherwise.
   *          Matches standard PERSIST return semantics.
   */
